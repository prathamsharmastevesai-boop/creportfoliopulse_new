...
export const ThePulse = () => {
  ...
  const [mainTab, setMainTab] = useState("dashboard"); // ✅ Default: dashboard
  ...
  return (
    ...
    >
        ...
        <div className="tp-header-left">
          ...
          {role === "user" && (
            <div className="tp-main-tabs">
              <button
                className={`tp-main-tab ${mainTab === "dashboard" ? "active" : ""}`}
      ...
      {mainTab === "dashboard" && <OwnerAdminDashboard />}

      {mainTab === "intelligence" && (
        <>
          <div className="d-flex align-items-center gap-2">
            <h2 className="tp-header-title">Market Intelligence</h2>
          </div>
          {kpiMetrics.length > 0 && (
