...
export const ConfirmModal = ({
  ...
  console.log(show, onHide, title, body, onConfirm, loading, "show");

  return (
    <Modal show={show} onHide={onHide} centered>
      <Modal.Header closeButton className="li-modal-header-custom">
        <Modal.Title className="li-modal-title-custom">{title}</Modal.Title>
      </Modal.Header>
      <Modal.Body className="li-modal-body-custom">{body}</Modal.Body>
